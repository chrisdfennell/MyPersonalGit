...
- **Mehrsprachigkeit / i18n** — Vollständige Lokalisierung über alle 30+ Seiten einschließlich der Web-IDE mit 1.088 Ressourcenschlüsseln. Wird mit 11 Sprachen ausgeliefert: Englisch, Spanisch, Französisch, Deutsch, Japanisch, Koreanisch, Chinesisch (vereinfacht), Portugiesisch, Russisch, Italienisch und Türkisch. Sprachauswahl in der Kopfzeile und in der oberen Leiste der IDE. Weitere Sprachen können durch Erstellen von `SharedResource.{locale}.resx`-Dateien hinzugefügt werden
