...
- **多言語 / i18n** — 全27ページにわたる676のリソースキーによる完全なローカライゼーション。11言語を同梱: 英語、スペイン語、フランス語、ドイツ語、日本語、韓国語、中国語（簡体字）、ポルトガル語、ロシア語、イタリア語、トルコ語。`SharedResource.{locale}.resx` ファイルを作成して言語を追加可能
