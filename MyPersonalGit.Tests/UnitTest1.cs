...
public class PullRequestServiceTests : IDisposable
{
    ...
    public PullRequestServiceTests()
    {
        ...
        _service = new PullRequestService(factory, NullLogger<PullRequestService>.Instance, _notifications, activityService, adminService, branchProtection, codeOwners, issueAutoClose, Substitute.For<IWorkflowService>(), Substitute.For<IGpgKeyService>(), Substitute.For<IAutoMergeService>(), config);
    }
